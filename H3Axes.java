...
public class H3Axes {
	...
	public void setAxisColor(float r, float g, float b) {
		ColoringAttributes attributes = new ColoringAttributes(r, g, b, ColoringAttributes.FASTEST);
	...
	private void createAxisLabels() {
		{
			...
			Appearance xAppearance = createLabelAppearance(new Color3f(0.5f, 0.1f, 0.1f));
...

		{
			...
			Appearance yAppearance = createLabelAppearance(new Color3f(0.1f, 0.5f, 0.1f));
...

		{
			...
			Appearance zAppearance = createLabelAppearance(new Color3f(0.1f, 0.1f, 0.5f));
	...
	private void createUnitSphere() {
...

		{
			...
			LineStripArray xyLines = new LineStripArray(xyPoints.length, GeometryArray.COORDINATES, stripLengths);
...

		{
			...
			LineStripArray yzLines = new LineStripArray(yzPoints.length, GeometryArray.COORDINATES, stripLengths);
...

		{
			...
			LineStripArray xzLines = new LineStripArray(xzPoints.length, GeometryArray.COORDINATES, stripLengths);
	...
	private Appearance createLabelAppearance(Color3f color) {
		...
		ColoringAttributes coloring = new ColoringAttributes(color, ColoringAttributes.FASTEST);
	...
	private void createGeneralAppearances() {
		{
			...
			ColoringAttributes coloringAttributes = new ColoringAttributes(0.3f, 0.6f, 0.3f,
