...
public class H3PointRenderList implements H3RenderList {
	////////////////////////////////////////////////////////////////////////
	// CONSTRUCTORS
	////////////////////////////////////////////////////////////////////////

	public H3PointRenderList(H3Graph graph, boolean useNodeSizes, boolean includeColors) {
		this(graph, useNodeSizes, true, includeColors, true, includeColors, true, includeColors);
	}

	public H3PointRenderList(H3Graph graph, boolean useNodeSizes, boolean includeNodes, boolean includeNodeColor,
			boolean includeTreeLinks, boolean includeTreeLinkColor, boolean includeNontreeLinks,
		...
		INCLUDE_NONTREE_LINKS = includeNontreeLinks && graph.getNumNontreeLinks() > 0;
		INCLUDE_NONTREE_LINK_COLOR = includeNontreeLinks && includeNontreeLinkColor;
	...
	public void addTreeLink(int link) {
		if (INCLUDE_TREE_LINKS && m_graph.checkLinkVisible(link)) {
			...
			if (SHOW_LINKS_OF_HIDDEN_NODES
					|| (m_graph.checkNodeVisible(sourceNode) && m_graph.checkNodeVisible(targetNode))) {
	...
	private void drawGeometry(GraphicsContext3D gc, Geometry geometry, Appearance appearance) {
		...
		// for (double d : m_nearNodes.getCoordRefDouble()){
		// 	System.out.print(d + " ");
		// }
		// System.out.println();
